    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <h1 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;m Tejsai Mylavarapu!!!
                
            </h1>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Enthusiastic AI/ML Developer</h1>
            <p className="max-w-2xl mx-auto font-Ovo">I am a Pre-final year student,currenlty working on AI/ML related Projects</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/Tejsai_Resume.pdf" download
